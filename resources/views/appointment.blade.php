...
<head>
    ...
    <!-- Favicon -->
    <link href="/assets/img/homeBG.jpg" rel="icon">
            ...
            <div class="row gx-5">
                <div class="col-lg-6 py-5">
                    <div class="py-5">
                        ...
                        <p class="text-white mb-0">We are dedicated to providing exceptional dental care with a compassionate touch. Our clinic is committed to delivering high-quality dental services in a comfortable and friendly environment.</p>
                    </div>
                </div>
                <div class="col-lg-6">
